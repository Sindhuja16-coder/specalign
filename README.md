...
SpecAlign is a generative UI logic auditor built on top of the Tambo Analytics Template.
...
See the upstream template demo: https://analytics-template-blush.vercel.app
...
- **SpecAlign generative UI components**: Start in `src/components/generative/`.
